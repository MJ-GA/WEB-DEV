...
<div class="container">  <!-- start main content container -->
   <div class="row">  <!-- start main content row -->
      ...
      <div class="col-md-9">  <!-- start main content column -->
         ...
         <h1><?php echo $images[1]['title']; ?></h1>
         <div class="row">
            <div class="col-md-8">
                   <?php    
            echo '<img src="'.$images[1]["path"].'">';
            ?>
            ...
            <div class="col-md-4">
               <div class="panel panel-primary">
                  <div class="panel-body">
                      <p>By <?php echo $images[1]["user"]; ?>   <a href="#"> </a>  </p>
                  <p>Taken in <?php echo $images[1]["country"]; ?>   <a href="#">country here</a></p>
                  <p><?php echo $images[1]["description"]; ?></p>
                   </div>
               </div>
            </div>
         </div>
